...
function SetupRecovery({ boot, setNotice, refreshSignal }) {
  ...
  return (
    <section className="stacked-panels">
      ...
      <div className="panel">
        <div className="panel-heading"><div><h2>Backups and restore</h2><p>Backups contain validated application data only. Temporary files, logs, credentials, models, and browser profiles are excluded.</p></div><Pill tone="info">{backups.length}</Pill></div>
