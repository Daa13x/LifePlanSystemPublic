...
assert.match(ui, /!IS_NATIVE && \(actionsOpen \|\| cloudPreview\) && <><div className="cloud-composer"/, 'unavailable desktop cloud controls are not shown in native Chat and stay contextual on desktop');
