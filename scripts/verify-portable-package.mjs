...
assert.match(packageScript, /-CacheRoot \(Join-Path \$cacheRoot 'llama'\)/);
assert.match(runtimeProvisioner, /runtimeServerSha256/);
assert.match(runtimeProvisioner, /runtimeBaseDllSha256/);
assert.match(runtimeProvisioner, /attempt -le 3/);
assert.match(runtimeProvisioner, /Test-LlamaRuntimePayload \$runtimeCache/);
